...
**Project Template**  
You are provided with a completed project that contains the class `MarsRover`, which contains fields and methods. DO NOT CHANGE the names, parameters and the return types of the existing methods.
